...
/**
 * ClassName: SystemBarUtils <br>
 * Description: 状态栏工具类
 * 状态栏两种模式(Android 4.4以上)<br>
 * 1.沉浸式全屏模式<br>
 * 2.状态栏着色模式<br>
 * https://github.com/H07000223/FlycoSystemBar<br>
 * Author: Cyarie <br>
 * Created: 2016/7/14 14:57 <br>
 * Update Time：<br>
...
public class SystemBarUtils {
    ...
    public static boolean isFlyme4Later() {
        ...
        return Build.DISPLAY.contains("Flyme OS 4") || Build.DISPLAY.contains("Flyme 5");
    }
