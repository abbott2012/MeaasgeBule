...
public class NotificationUtils {
     ...
     * @param content
     */
    public void notifyMoreLine(PendingIntent pendingIntent, int smallIcon, String ticker,
                               String title, String content, boolean sound, boolean vibrate, boolean lights) {

        final int sdk = Build.VERSION.SDK_INT;
        if (sdk < Build.VERSION_CODES.JELLY_BEAN) {
            notifyNormal(pendingIntent, smallIcon, ticker, title, content, sound, vibrate, lights);
        } else {
