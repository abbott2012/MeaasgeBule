...
public class UserInfoFragment1 extends BaseFragment {
    ...
    public static UserInfoFragment1 getInstance() {
        UserInfoFragment1 fragment = new UserInfoFragment1();
        return fragment;
    }
...
//                Crop.pickImage(_mActivity, this);
                showOpen();
                break;
        }
    }
...
//        Uri destination = Uri.fromFile(new File(plate_str));
//        Crop.of(source, destination).asSquare().start(_mActivity, this);
//    }

//    private void handleCrop(int resultCode, Intent result) {
//        if (resultCode == RESULT_OK) {
////            uploadAvar(Crop.getOutput(result));
//        } else if (resultCode == Crop.RESULT_ERROR) {
//            Toast.makeText(_mActivity, Crop.getError(result).getMessage(), Toast.LENGTH_SHORT).show();
//        }
//    }

    //上传头像
    private void uploadAvar(/*Uri uri*/) {
        String platestrBase64 = Utils.base64Pic(plate_str);
...
//                        ImageUtil.loadRoundUri(_mActivity, uri, mIvUserPic);
