 ...
 */
public class SearchTagAct extends BaseAct implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        mp = MediaPlayer.create(SearchTagAct.this, R.raw.beep);
...
//                reader.bleSendCmd(Constant.OPEN_TAG_DATA_OUTPUT, BlueToothHelper.OPEN_TAG_OUTPUT_COMMAND, false);
    ...
    private void initView() {
        ...
        adapter = new TagAdapter(SearchTagAct.this, dataList);
...
//                            reader.bleSendCmd(Constant.OPEN_TAG_DATA_OUTPUT, BlueToothHelper.OPEN_TAG_OUTPUT_COMMAND, false);
    ...
    private void startScan() {
        ...
        if (reader.getBluetoothType() == BluetoothDevice.DEVICE_TYPE_CLASSIC) {
            ...
            reader.setBleCmdType(Constant.BLE_SCAN_TAG);
        }
        if (scanType == 2) { //搜索
            startTimer();
            startClearTimer();
...
//                        dataList.clear(); //填充数据前先清空集合
    ...
    public class TagAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                view = inflater.inflate(R.layout.lv_item_taginfo, null);
...
//                reader.bleSendCmd(Constant.BLE_CLOSE_TAG_DATA_OUTPUT, BlueToothHelper.CLOSE_TAG_OUTPUT_COMMAND, false);
                ...
                reader.bleSendCmd(Constant.OPEN_TAG_DATA_OUTPUT, BlueToothHelper.STOP_SET_SIX_BYTE_OF_SEARCH, false);
