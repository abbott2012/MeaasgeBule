...
/**
 * ClassName: DividerGridItemDecoration <br>
 * Description: RecyclerView Item Divider Decoration<br>
 * Author: Cyarie <br>
 * Created: 2016/7/19 15:49 <br>
 * Update Time：<br>
...
public class GridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public GridItemDecoration(Context context, int[] drawableResId) {
        final TypedArray a = context.obtainStyledAttributes(drawableResId);
        mDivider = a.getDrawable(0);
        a.recycle();
    }
