...
public class MoneyTextView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mGravity = typedArray.getInt(R.styleable.MoneyTextView_baseGravity, GRAVITY_CENTER_VERTICAL | GRAVITY_CENTER_HORIZONTAL);
            ...
            //是否画中间线
            mDecimalSection.drawMidLine = typedArray.getBoolean(R.styleable.MoneyTextView_textMidLine, false);
            mSymbolSection.drawMidLine = typedArray.getBoolean(R.styleable.MoneyTextView_textMidLine, false);
            mIntegerSection.drawMidLine = typedArray.getBoolean(R.styleable.MoneyTextView_textMidLine, false);

            //是否粗体
            mDecimalSection.textBold = typedArray.getBoolean(R.styleable.MoneyTextView_textBold, false);
            mSymbolSection.textBold = typedArray.getBoolean(R.styleable.MoneyTextView_textBold, false);
            mIntegerSection.textBold = typedArray.getBoolean(R.styleable.MoneyTextView_textBold, false);
    ...
    private void drawSection(Canvas canvas, Section section) {
        ...
        mTextPaint.setStrikeThruText(section.drawMidLine);
        mTextPaint.setFakeBoldText(section.textBold);
