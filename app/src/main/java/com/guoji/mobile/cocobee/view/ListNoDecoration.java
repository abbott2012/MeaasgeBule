 ...
 */
public class ListNoDecoration extends RecyclerView.ItemDecoration {

    private Drawable mDrawable;

    public ListNoDecoration() {
        mDrawable = ResCompat.getDrawable(ElectricVehicleApp.getApp(), R.drawable.drawable_no_line);
    }
