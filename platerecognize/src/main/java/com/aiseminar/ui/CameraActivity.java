...
public class CameraActivity extends Activity implements SurfaceHolder.Callback ,View.OnClickListener{
    ...
    ImageButton imbtn_camera_back,imbtn_flash;
...
//                mCamera.setParameters(params);
        ...
        }else if(i1 == R.id.imbtn_camera_back){
            finish();
        }else if(i1 == R.id.imbtn_flash){
    ...
    public void cropBitmapAndRecognize(Bitmap originalBitmap) {
        ...
        try {
            ...
            if (null != plate && ! plate.equalsIgnoreCase("0")) {
                ...
                String[] plateArray = plate.split(":");
                Intent i = new Intent();
                i.putExtra("plate",plateArray[1]);
                setResult(2324,i);
                finish();
            } else {
