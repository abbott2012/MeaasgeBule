...
import com.bql.tablayout.listener.CustomTabTextEntity;
import com.bql.tablayout.listener.OnTabClickListener;
import com.bql.tablayout.listener.OnTabSelectListener;
import com.bql.tablayout.utils.FragmentChangeManager;
 ...
 */
public class CommonTextTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {

    private Context mContext;
    private ArrayList<CustomTabTextEntity> mTabEntitys = new ArrayList<>();
    ...
    public CommonTextTabLayout(Context context) {
        this(context, null, 0);
    }

    public CommonTextTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CommonTextTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.CommonTextTabLayout);
    ...
    public void setTabData(ArrayList<CustomTabTextEntity> tabEntitys) {
     ...
     * 关联数据支持同时切换fragments
     */
    public void setTabData(ArrayList<CustomTabTextEntity> tabEntitys, FragmentActivity fa, int containerViewId, ArrayList<Fragment> fragments) {
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, R.layout.layout_tab_text, null);
            tabView.setTag(i);
            addTab(i, tabView);
        }
        updateTabStyles();
    ...
    private void addTab(final int position, View tabView) {
        ...
        TextView iv_tab_subtitle = (TextView) tabView.findViewById(R.id.iv_tab_sub_title);
        iv_tab_subtitle.setText(mTabEntitys.get(position).getTabSubTitle());
        iv_tab_subtitle.setTextColor(mTabEntitys.get(position).getTabUnselectedIColor());
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            TextView iv_tab_subtitle = (TextView) tabView.findViewById(R.id.iv_tab_sub_title);
            iv_tab_subtitle.setVisibility(View.VISIBLE);
            CustomTabTextEntity tabEntity = mTabEntitys.get(i);
            iv_tab_subtitle.setTextColor(i == mCurrentTab ? tabEntity.getTabSelectedColor() : tabEntity.getTabUnselectedIColor());
            ...
            //                }
            //
            //                iv_tab_subtitle.setLayoutParams(lp);
            //            } else {
            //                iv_tab_subtitle.setVisibility(View.GONE);
            //            }
    ...
    public void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            TextView iv_tab_subtitle = (TextView) tabView.findViewById(R.id.iv_tab_sub_title);
            CustomTabTextEntity tabEntity = mTabEntitys.get(i);
            iv_tab_subtitle.setTextColor(isSelect ? tabEntity.getTabSelectedColor() : tabEntity.getTabUnselectedIColor());
        }
    }
