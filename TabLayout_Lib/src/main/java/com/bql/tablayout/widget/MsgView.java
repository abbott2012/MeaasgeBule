package com.bql.tablayout.widget;
...
import com.bql.tablayout.R;

/**
 * ClassName: MsgView <br>
 * Description: 用于需要圆角矩形框背景的TextView的情况,减少直接使用TextView时引入的shape资源文件<br>
 * Author: Cyarie <br>
 * Created: 2016/4/19 10:54 <br>
 * Update Time：<br>
