 ...
 */
public class
CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
        ...
        tabView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCurrentTab != position) {
                    ...
                    if (mListener != null) {
                        mListener.onTabSelect(position, mLastTab);
                    }
                } else {
                    if (mListener != null) {
...
//            }
    ...
    private OnTabSelectListener2 mListener;

    public void setOnTabSelectListener(OnTabSelectListener2 listener) {
    ...
    public void setTabEntitys(ArrayList<CustomTabEntity> tabEntitys) {
        this.mTabEntitys.clear();
        this.mTabEntitys.addAll(tabEntitys);
    }
}
