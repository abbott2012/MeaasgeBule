...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
     ...
     * activity嵌套fragment使用getSupportFragmentManager() fragment嵌套fragment使用getChildFragmentManager，防止数据混乱丢失
     */
    ...
    public OnViewPageSelected mViewPageSelected;

    public void setOnViewPageSelected(OnViewPageSelected mViewPageSelected) {
        this.mViewPageSelected = mViewPageSelected;
    }

    @Override
    public void onPageSelected(int position) {
        updateTabSelection(position);
        if (mViewPageSelected != null) {
            mViewPageSelected.onViewPageSelected(position);
        }
    }
