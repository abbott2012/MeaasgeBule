...
import com.bql.pulltorefreshandloadmore.ultraptr.util.PtrCLog;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    private void updatePos(int change) {
        ...
        if (mOnUIScrollChange != null) {
            mOnUIScrollChange.onUIScrollChange(this, isUnderTouch, mStatus, mPtrIndicator);
        }
    ...
    public interface OnUIScrollChange {
        void onUIScrollChange(PtrFrameLayout frame, boolean isUnderTouch, byte status, PtrIndicator ptrIndicator);
    }

    private OnUIScrollChange mOnUIScrollChange;

    public void setOnUIScrollChangeListener(OnUIScrollChange onUIScrollChange) {
        mOnUIScrollChange = onUIScrollChange;
    }
