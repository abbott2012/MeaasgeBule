...
/**
 * ClassName: LoadMoreExpandListView <br>
 * Description: 可加载更多的ExpandListView<br>
 * Author: Cyarie <br>
 * Created: 2016/4/14 17:02 <br>
 * Update Time：<br>
 * Update Description：<br>
 */
public class LoadMoreExpandListView extends ExpandableListView implements OnScrollBottomListener {
    ...
    public LoadMoreExpandListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public LoadMoreExpandListView(Context context, AttributeSet attrs, int defStyleAttr) {
