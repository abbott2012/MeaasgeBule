package com.bql.materialprogressbar;
 ...
 * Created by Cyarie on 2016/3/28.
 */
public class MaterialProgressBar extends View {
     ...
     * 轮子颜色
     */
    private int mBarColor = 0xFF00CCCC;
    /**
     * 轮子半径
     */
    ...
    private void parseAttributes(Context context, AttributeSet attrs) {
        ...
        mProgress = array.getFloat(R.styleable.MaterialProgressBar_mp_bar_progress, 0.0f);
        mMax = array.getFloat(R.styleable.MaterialProgressBar_mp_bar_max, 100f);
        mSpinSpeed = array.getInteger(R.styleable.MaterialProgressBar_mp_bar_speed, 2);
        mBarColor = array.getColor(R.styleable.MaterialProgressBar_mp_bar_color, mBarColor);
        mBarWidth = array.getDimensionPixelSize(R.styleable.MaterialProgressBar_mp_bar_width, mBarWidth);
        int mode = array.getInt(R.styleable.MaterialProgressBar_mp_bar_mode, 0);
        switch (mode) {
            case 0:
        ...
        mRimColor = array.getColor(R.styleable.MaterialProgressBar_mp_rim_color, mRimColor);
        mRimWidth = array.getDimensionPixelSize(R.styleable.MaterialProgressBar_mp_rim_width, mRimWidth);
        showRim = array.getBoolean(R.styleable.MaterialProgressBar_mp_show_rim, showRim);
        array.recycle();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCurMode == Mode.INDETERMINATE) {
            ...
            canvas.drawArc(mBounds, 0, mProgress / mMax * 360, false, mPaint);
        }

    }

    public void setProgress(float progress) {
        if (progress > mMax || progress < 0f) {
            return;
        }
